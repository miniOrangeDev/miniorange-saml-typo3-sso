...
class TestResultActions
{
    ...
    private $successHeader  = ' <div style="color: #3c763d;background-color: #dff0d8; padding:2%%;margin-bottom:20px;text-align:center; 
                                ...
                                <div style="display:block;text-align:center;margin-bottom:4%%;"><img style="width:15%%;" src="typo3conf/ext/ekey/Resources/Public/Icons/right.png"></div>';
    ...
    private $errorHeader    = ' <div style="color: #a94442;background-color: #f2dede;padding: 15px;margin-bottom: 20px;text-align:center;
                                ...
                                </div><div style="display:block;text-align:center;margin-bottom:4%%;"><img style="width:15%%;" src="typo3conf/ext/ekey/Resources/Public/Icons/wrong.png"></div>';
